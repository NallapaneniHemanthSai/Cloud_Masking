...
IMPORTABLE_MODULES = [
    ...
    "app.failure_analysis",
    "app.failure_analysis.taxonomy",
    "app.failure_analysis.config",
    "app.failure_analysis.records",
    "app.failure_analysis.pixel_analysis",
    "app.failure_analysis.sample_analysis",
    "app.failure_analysis.ranking",
    "app.failure_analysis.stratification",
    "app.failure_analysis.analyzer",
    "app.failure_analysis.viz_specs",
    "app.failure_analysis.report",
    "app.datasets",
